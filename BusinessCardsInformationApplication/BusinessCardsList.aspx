            ...
            <asp:Repeater runat="server" ID="repeaterBusinessCards">
                ...
                <ItemTemplate>
                        <tr>
                            ...
                            <td><asp:Button runat="server" ID="btnDelete" Text="Delete" OnClientClick="return confirm('Are you sure you want to delete the selected row?');" OnClick="BtnDeleteClicked" Width="75px"/></td>
                        </tr>
                </ItemTemplate>
